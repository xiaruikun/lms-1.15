...
<html>
    ...
    <body>
        ...
        <div id="show-accountType" class="content scaffold-show" role="main">
            ...
            <f:display bean="accountType" />
            <g:form resource="${this.accountType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.accountType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
