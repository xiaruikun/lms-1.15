...
<head>
    ...
    <g:set var="entityName"
           value="${message(code: 'workflowUser.label', default: 'workflowUser')}"/>
...
<div class="content animate-panel">
    <div class="row">
        <div class="hpanel hblue">
            ...
            <div class="panel-body">
                <g:form resource="${this.workflowUser}" method="PUT" class="form-horizontal">
                    <g:if test="${flash.message}">
                        <div class="message" role="status">${flash.message}</div>
                    </g:if>
                    <g:hasErrors bean="${this.workflowUser}">
                        <ul class="errors" role="alert">
                            <g:eachError bean="${this.workflowUser}" var="error"><li
