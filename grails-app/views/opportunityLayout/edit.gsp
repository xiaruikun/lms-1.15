    ...
    <div class="hpanel">
        <div class="panel-body">
            ...
            <h2 class="font-light m-b-xs">
                布局: ${this.opportunityLayout?.name}
            </h2>
        </div>
    </div>
</div>
...
<div class="content animate-panel">
    <div class="row">
        <div class="hpanel hblue">
            ...
            <div class="panel-body">
                <g:form resource="${this.opportunityLayout}" method="PUT" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:textField name="name" value="${this.opportunityLayout?.name}" disabled=""
                                         class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:textField name="description" value="${this.opportunityLayout?.description}"
                                         class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-3">
                            <input type="hidden" value="${this.opportunityLayout?.active}" id="active">
