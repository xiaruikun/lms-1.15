...
<div class="small-header">
    <div class="hpanel">
        <div class="panel-body">
            ...
            <small><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>返费基础信息</small>
        </div>
    </div>
</div>
...
<div class="content animate-panel">
    ...
    <div class="row">
        <g:form name="form" method="POST" action="exportCommissionInfo4">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '对公渠道名称')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '对私渠道名称')}"/>
                            <g:sortableColumn property="authority"
                        ...
                        <g:each in="${list}">
                            <tr>
                                ...
                                <td>${it[1]}</td>
                                <td>${it[2]}</td>
                                <td><g:formatNumber number="${it[3]}" minFractionDigits="2" maxFractionDigits="5"/></td>
                                <td><g:formatNumber number="${it[4]}" minFractionDigits="2" maxFractionDigits="5"/></td>
