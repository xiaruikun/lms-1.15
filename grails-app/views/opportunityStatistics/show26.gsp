        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb m-t-none">
                    <li>中佳信LMS</li>
                    <li>
                        <g:link controller="opportunityStatistics" action="rongshuLoanInfo">订单管理</g:link>
                    </li>
                    <li class="active">
                        <span>信息查看</span>
                    </li>
...
<div class="content animate-panel">
        ...
        <div class="hpanel hred">
            <div class="panel-heading">
                <div class="panel-tools">
                    ...
                    <g:link id="${this.opportunity?.id}" action="show27"
                    ...
                    <table class="table table-striped table-bordered table-hover text-center">
                        ...
                        <g:if test="${this?.opportunity?.parent && this?.opportunity?.type?.code == '30'}">
                            <g:each in="${com.next.OpportunityProduct.findAllByOpportunityAndProduct(this?.opportunity?.parent, this?.opportunity?.parent?.productAccount)}">
                                <g:if test="${it.productInterestType?.name !="服务费费率"&&it.productInterestType?.name !="渠道返费费率"}">
                                    <tr>
                                        <td>
        ...
        <div class="hpanel hgreen">
            ...
            <div class="panel-body p-xs">
                <div class="comment-area">
                    ...
                    授信金额：<g:formatNumber number="${this.opportunity?.actualAmountOfCredit}" minFractionDigits="2"
    ...
    <div class="row">
        <div class="hpanel hgreen">
            ...
            <div class="panel-body p-xs"  style="border-top: 2px solid #316FCB;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:select class="form-control" name="rongShuStatus" id="rongShuStatus"
                                      value="${this.opportunity.rongShuStatus}"
                                      from="${["请选择","通过","未通过"]}"/>
                        ...
                        <div class="col-md-3">
                            <g:link class="btn btn-outline btn-primary" controller="attachments"
                                    action="create01" id="${this.opportunity.id}"
                                    params="[attachmentTypeName: '签约录像']">审核通知书上传</g:link>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <div class="col-md-3 col-lg-offset-5">
                                <button class="btn btn-info rongShuSubmit">提交</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "/opportunityStatistics/ajaxRongShuApproval",
                            data: {
                                opportunityId: $("#opportunityId").val(),
                                rongShuStatus: $("#rongShuStatus").val()
                            },
                            beforeSend: function () {
                                if (laddaBtn && spinner) {
                                    spinner.start();
