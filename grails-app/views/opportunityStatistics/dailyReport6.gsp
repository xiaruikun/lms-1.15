...
<div class="content animate-panel">
    ...
    <div class="row">
        <g:form name="form" method="POST" action="dailyReport6">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '合同还款日期')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '最终还款日期')}"/>
                        </tr>
                        </thead>
                        <tbody>
                        <g:each in="${list}">
                            <tr>
                                ...
                                <td><g:formatNumber number="${it[25]}" maxFractionDigits="2"/></td>
                                <td><g:formatNumber number="${it[26]}" maxFractionDigits="2"/></td>
                                <td>${it[27]}</td>
                                <td>${it[28]}</td>
                                <td>${it[29]}</td>
                                <td>${it[30]}</td>
