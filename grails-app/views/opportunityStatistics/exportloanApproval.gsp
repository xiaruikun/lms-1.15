...
<div class="small-header">
    <div class="hpanel">
        <div class="panel-body">
            ...
            <small><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>审批基础信息</small>
        </div>
    </div>
</div>
...
<div class="content animate-panel">
    ...
    <div class="row">
        <g:form name="form" method="POST" action="exportloanApproval">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group date form_datetime">
                            ...
                            <input title="审批开始时间" type="text" name="startTime" id="startTime"
                                   placeholder="审批开始时间" value="${params?.startTime}" readonly
                    ...
                    <div class="col-sm-3">
                        <div class="input-group date form_datetime">
                            ...
                            <input title="审批结束时间" type="text" name="endTime" id="endTime" placeholder="审批结束时间"
                                   value="${params?.endTime}" readonly class="form-control daily-b">
                        </div>
                    </div>

                    <div class="col-sm-3">
                         <input type="text" class="form-control" placeholder="订单编号" id="serialNumber" name="serialNumber" value="${params?.serialNumber}">
                    </div>

                    <div class="col-sm-3">
                        <g:select class="form-control daily-b " name="city" id="city" from="${["--CITY--", "北京", "上海", "合肥", "南京", "成都", "青岛", "济南", "西安","郑州","石家庄","厦门","武汉"]}"
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '客户级别')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '产品')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '渠道名称')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '申请总价')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '实际授信金额')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '实际放款金额')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '审批日期')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '抵押凭证')}"/>
                            <g:sortableColumn property="authority"
                                              title="${message(code: 'message.authority.label', default: '申请日期')}"/>
                        </tr>
                        </thead>
                        <tbody>
                        <g:each in="${list}">
