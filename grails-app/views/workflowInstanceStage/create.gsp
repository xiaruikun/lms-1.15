                  ...
                  <div class="panel-body">
                      ...
                      <ul class="errors" role="alert">
                          ...
                          <div class="form-group">
                              <g:textField name="instance.id" required="required" id="instance"
                                           value="${this.workflowInstanceStage?.instance?.id}" class="hide"/>

                              <label class="col-md-4 control-label">名称</label>

                              <div class="col-md-3">
                                  <g:textField name="name"
                                               value="${this.workflowInstanceStage?.name}"
                                               class="form-control"/>
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-3">
                                  <g:textField name="executionSequence"
                                               value="${this.workflowInstanceStage?.executionSequence}"
                                               class="form-control"/>
                              </div>
                          </div>
