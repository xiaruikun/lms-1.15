          ...
          <div class="hpanel">
              <div class="panel-body">
                  ...
                  <h2 class="font-light m-b-xs" style="text-transform:none;">
                      弹性域模块: ${this.opportunityFlexField?.category?.flexFieldCategory?.name}
                  </h2>
              </div>
          </div>
      </div>
                      ...
                      <div id="create-flexField" class="content scaffold-create" role="main">
                        ...
                        <ul class="errors" role="alert">
                          ...
                          <g:form action="save" class="form-horizontal">
                              <input type="hidden" name="category.id" id="category" value="${this.opportunityFlexField?.category?.id}">
