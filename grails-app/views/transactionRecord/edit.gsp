...
<div class="content animate-panel">
    %{--<g:form resource="${this.transactionRecord}" method="PUT">
        <g:hiddenField name="version" value="${this.transactionRecord?.version}"/>
        <fieldset class="form">
            <f:all bean="transactionRecord"/>
        </fieldset>
    ...
    <div class="row">
        <div class="hpanel hblue">
            ...
            <div class="panel-body">
                <g:form resource="${this.transactionRecord}" method="PUT" class="form-horizontal">
                   ...
                   %{-- <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <g:select name="type.id" id="type" value="${this.transactionRecord?.type?.id}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <g:select name="debit" value="${this.transactionRecord?.debit?.id}"
                    ...
                    <g:select name="debit" value="${this.transactionRecord?.debit}"
                              from="${com.next.OpportunityFlexField.findByCategoryAndName(com.next.OpportunityFlexFieldCategory.findByOpportunityAndFlexFieldCategory(this.transactionRecord?.opportunity, com.next.FlexFieldCategory.findByName("资金渠道")), "放款账号")}"
                              optionKey="id" optionValue="value" class="form-control"/>
                    </div>
                </div> -->
                ...
                <div class="form-group">
                    ...
                    <g:datePicker name="plannedStartTime" value="${this.transactionRecord?.plannedStartTime}" precision="day" default="none" noSelection="['': '-请选择-']"/>
                    </div>
                  </div>
                    <div class="hr-line-dashed"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5 datePicker">
                            <g:datePicker name="plannedEndTime" value="${this.transactionRecord?.plannedEndTime}" precision="day" default="none" noSelection="['': '-请选择-']"/>
                        </div>
                    </div>
                    <!-- <div class="hr-line-dashed"></div>
                    <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5 datePicker">
                            <g:datePicker name="endTime" value="${this.transactionRecord?.endTime}" precision="day" default="none" noSelection="['': '-请选择-']"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5 datePicker">
                            <g:textField class="form-control" value="${this.transactionRecord?.debitAccount}" name="debitAccount"></g:textField>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <g:select name="repaymentMethod.id" id="repaymentMethod"
                                      from="${com.next.RepaymentMethod.list()}" value="${this.transactionRecord?.repaymentMethod?.id}" optionKey="id"
                                      optionValue="name" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <g:select name="status.id" id="status" value ="${this.transactionRecord?.status?.id}" from="${com.next.TransactionRecordStatus.list()}" optionKey="id"
                                      optionValue="name" class="form-control"/>
                        </div>
                    </div>
