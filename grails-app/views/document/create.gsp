...
<div class="content animate-panel">
    <div class="row">
        <div class="hpanel hblue">
            ...
            <div class="panel-body">
                <g:form action="save" class="form-horizontal documentForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:textField name="title" value="${this.document?.title}" required ="" maxlength="128" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 checkbox-inline">
                            <g:checkBox class="i-checks" name="active" style="margin-left: 20px" value="${this.document?.active}" checked="true"/>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
