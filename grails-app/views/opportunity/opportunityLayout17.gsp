        ...
        <div class="hpanel hred">
            <div class="panel-heading">
                <div class="panel-tools">
                    <!--  <g:link id="${this.opportunity?.id}" controller="opportunity" action="loanApplicationForm"
                                  class="btn btn-success btn-xs"><i class="fa fa-external-link"></i>借款申请表
                    </g:link> -->
