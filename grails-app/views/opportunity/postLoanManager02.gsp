...
<head>
    ...
    <title>${this.opportunity?.serialNumber}${this.opportunity?.type?.name}申请</title>
</head>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    ...
                    <li class="active">
                        <span>${this.opportunity?.type?.name}申请</span>
                    </li>
                </ol>
            </div>

            <h2 class="font-light m-b-xs">
                ${this.opportunity.serialNumber}${this.opportunity?.type?.name}申请
            </h2>
        </div>
    </div>
</div>
            ...
            <div class="panel-footer contact-footer">
                <div class="row">
                    ...
                    <div class="col-md-2 border-right">
                        <div class="contact-stat">
                            <span>原评房单价</span>
                            <strong><g:formatNumber number="${this.opportunity?.parent?.unitPrice}"
                                                    minFractionDigits="2" maxFractionDigits="2"/>元</strong>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 border-right">
                        <div class="contact-stat">
                            ...
                            <strong><g:formatNumber number="${this.opportunity?.parent?.loanAmount}"
                                                    minFractionDigits="2" maxFractionDigits="2"/>万元</strong>
                        </div>
                    </div>
            ...
            <div class="panel-body">
                <g:form resource="${this.opportunity}" action="postLoan" name="myForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">约定还款日</label>
                    ...
                    <div class="form-group">
                        <div class="col-md-3 col-md-offset-4">
                            <input type="button" class="btn btn-info" value="申请" onclick="postLoan()"/>
                        </div>
                    </div>
                </g:form>
            </div>
    ...
    function postLoan(){
        var aa= ""
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "/opportunity/afterPostLoan",
                data: {
                    opportunityId: $("#parent").val(),
