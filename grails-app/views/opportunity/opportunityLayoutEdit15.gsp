...
<head>
    ...
    <title>administratorEdit3.0-15</title>
    <style>
            ...
            <div class="hpanel hyellow">
                ...
                <div class="panel-body form-horizontal">
                    ...
                    <div class="form-group m-b-none">
                        ...
                        <div class="col-md-3">
                            <g:select class="form-control" name="reportTo" required="required" id="reportTo"
                                      optionValue="" optionKey="id"
                                      from="${com.next.User.list()}" value="${this.opportunity?.user?.reportTo?.id}"
                                      noSelection="${['null': '--请选择--']}"></g:select>

                        </div>--}%
                        <label class="col-md-3 control-label">是否为测试单：</label>

                        <div class="col-md-3">
                            <span class="cont">
                                <g:checkBox name="isTest" value="${this.opportunity?.isTest}"/>
                            </span>
            ...
            <div class="hpanel hblue">
                ...
                <div class="panel-body form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-md-2 interestPaymentMethod">
                            <g:select class="form-control" optionKey="id" optionValue="name"
