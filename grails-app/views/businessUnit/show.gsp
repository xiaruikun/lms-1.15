...
<html>
    ...
    <body>
        ...
        <div id="show-businessUnit" class="content scaffold-show" role="main">
            ...
            <f:display bean="businessUnit" />
            <g:form resource="${this.businessUnit}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.businessUnit}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
