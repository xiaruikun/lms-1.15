    ...
    <div class="row">
        <div class="hpanel hgreen">
            ...
            <div class="panel-body form-horizontal">
                ...
                <g:form resource="${this.appConfiguration}" method="PUT" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:select class="form-control m-b" name="key" id="key" required="required"
                                      from="${com.next.AppConfigurationKey.list()}"
                                      optionKey="id" optionValue="name"
                                      value="${this.appConfiguration?.key?.id}"></g:select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:textField type="text" id="value" name="value" required="required" class="form-control"
                                         maxlength="256" value="${this.appConfiguration?.value}"/>
                        </div>
                    </div>
