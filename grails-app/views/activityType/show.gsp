...
<html>
    ...
    <body>
        ...
        <div id="show-activityType" class="content scaffold-show" role="main">
            ...
            <f:display bean="activityType" />
            <g:form resource="${this.activityType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.activityType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
