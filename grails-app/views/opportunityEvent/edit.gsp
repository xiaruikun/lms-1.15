...
<div class="content animate-panel">
    <div class="row">
        <div class="hpanel hblue">
            ...
            <div class="panel-body">
                <g:form resource="${this.opportunityEvent}" method="PUT" class="form-horizontal flowForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="hidden" value="${this.opportunityEvent?.isSynchronous}" id="isSynchronous">
