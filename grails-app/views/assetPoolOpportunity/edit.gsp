...
<div class="content animate-panel">
    <div class="row">
        %{--<g:form resource="${this.assetPoolOpportunity}" method="PUT">
            <g:hiddenField name="version" value="${this.assetPoolOpportunity?.version}" />
            <fieldset class="form">
        ...
        <div class="hpanel hblue">
            ...
            <div class="panel-body">
                <g:form resource="${this.assetPoolOpportunity}" method="PUT" class="form-horizontal">
