    ...
    <div class="hpanel">
        <div class="panel-body">
            ...
            <h2 class="font-light m-b-xs" style="text-transform:none;">
                产品: ${com.next.ProductAccount.findById(params['id'])?.product?.name}
            </h2>
        </div>
    </div>
</div>
            ...
            <div class="panel-body">
                ...
                <g:form action="save" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:textField class="form-control" type="text" name="mortgageRate" id="mortgageRate"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:select class="form-control m-b" name="assetType.id" id="assetType"
                                      from="${assetTypeList}"
