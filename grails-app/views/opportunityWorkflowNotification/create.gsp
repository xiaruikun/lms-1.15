...
<head>
    ...
    <g:set var="entityName"
           value="${message(code: 'opportunityWorkflowNotification.label', default: 'OpportunityWorkflowNotification')}"/>
    <title>新增区域消息</title>
        ...
        <div class="hpanel hblue">
            ...
            <div class="panel-body">
                <g:form action="save" class="form-horizontal">
                    ...
                    <g:hasErrors bean="${this.opportunityWorkflowNotification}">
                        <ul class="errors" role="alert">
                            <g:eachError bean="${this.opportunityWorkflowNotification}" var="error">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <g:textField name="workflow.id" required="required" id="workflow"
                                         value="${this.opportunityWorkflowNotification?.workflow?.id}" class="hide"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <g:select class="form-control" name="user.id" id="user"
                                      value="${this.opportunityWorkflowNotification?.user}" from="${this.userList}" noSelection="['':'-请选择-']"
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">订单阶段</label>

                        <div class="col-md-4">
                            <g:select class="form-control" name="stage.id" required="required" id="stage"
                                      value="${this.opportunityWorkflowNotification?.stage}"
                                      from="${this.opportunityStages}" optionKey="id"></g:select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <g:select class="form-control" name="messageTemplate.id" required="required"
                                      id="messageTemplate"
                                      value="${this.opportunityWorkflowNotification?.messageTemplate}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <g:textArea name="cellphone" id="code1" value="${this.opportunityWorkflowNotification?.cellphone}" class="form-control textarea"
                                        rows="25" cols="15"/>
