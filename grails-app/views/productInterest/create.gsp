            ...
            <div class="panel-body">
                ...
                <g:form action="save" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:textField class="form-control" type="text" name="minimumRate" id="minimumRate"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <g:textField class="form-control" type="text" name="maximumRate" id="maximumRate"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            <g:checkBox name="installments" value="${false}" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            <g:checkBox name="fixedRate" value="${true}" class="form-control"
                                        style="height:16px;margin-top: 10px"/>
                        </div>
                    </div>
