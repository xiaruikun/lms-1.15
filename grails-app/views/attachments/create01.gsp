        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>中佳信LMS</li>
                    <li>
                        <g:link controller="opportunityStatistics" action="show26" id="${attachments?.opportunity?.id}">订单</g:link>
                    </li>
                    <li class="active">
                        <span>新增附件</span>
                    </li>
                    ...
                    <g:form class="fileupload3 form-horizontal" controller="attachments" action="uploadAvatar" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <!-- The table listing the files available for upload/download -->
                                <p style="margin-top: 10px;">
                                    <code>视频大小不能超过 30M，视频格式mov、mp4、avi、rm、3gp、mkv、wmv、ogg、rmvb</code>
                                </p>
                                <table role="presentation" class="table table-striped"><tbody class="files"></tbody></table>
...
<script>
    $(function () {
        ...
        $('.fileupload3').fileupload({
            ...
            maxNumberOfFiles: 5,
            acceptFileTypes: /(\.|\/)(mov|mp4|avi|rm|3gp|mkv|wmv|ogg|rmvb)$/i
        });
    });
</script>
</body>
