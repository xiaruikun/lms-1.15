            ...
            <div class="panel-body">
                <g:form action="save" class="form-horizontal flowForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <g:textArea name="message" id="code2" value="${this.territoryFlowCondition?.message}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <g:textArea name="condition" id="code1" value="${this.territoryFlowCondition?.condition}"
                                        class="form-control textarea" rows="10" cols="15"/>
