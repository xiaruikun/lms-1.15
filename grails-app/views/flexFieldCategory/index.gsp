...
<div class="content animate-panel">
    <div class="row">
        <g:form method="POST" action="searchFieldCategory">
            <div class="hpanel hblue">
                ...
                <div class="panel-body">
                    <div class="col-sm-4">
                        <input type="text" class="form-control" placeholder="弹性域模块" name="name" id="name"
                               value="${params?.name}">
                    </div>
                </div>
            </div>
        ...
        <div class="hpanel hgreen">
            ...
            <div class="panel-footer">
                <div class="pagination">
                    <g:paginate total="${flexFieldCategoryCount ?: 0}" params="${params}"/>
                </div>
            </div>
        </div>
    </div>
